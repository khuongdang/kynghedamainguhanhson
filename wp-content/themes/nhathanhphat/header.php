                ...
                <div class="banner-content-right">
                    <div class="b-c-lang">
                        <ul class="menu_MenuTopSub top-level" id="menu_MenuTopSub">
                            ...
                            <li><a class="menu_MenuTopSub" id="p_6" href="<?php echo get_page_link($page::LIEN_HE)?>">Liên hệ</a>
                        </ul>
                    </div>
                    <!-- search -->
                    <div class="search">
                        ...
                        <div class="email"><span>Email: <font color="#4263aa">luattritam1@gmail.com<br/><br
                                        type="_moz"/></font></span></div>
                        <div class="hotline"><span>Hotline: 0964-988.999 </span></div>
                    </div>
                    <!-- end of search -->
